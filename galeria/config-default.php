...
$title = "Galeria de foto Avanildo  Construções"; // Text to be displayed in browser titlebar
$author = "Avanildo";
...
//LANGUAGE STRINGS
$label_home = "Inicio"; // Name of home link in breadcrumb navigation
...
$label_noimages = "Ainda não temos imagem !"; // Empty folder text
$label_noimages_advice = "Use o ftp para carregar us imagem !";
$label_loading = "Loading..."; // Thumbnail loading text
$breadcrumb_separator = "/"; // Breadcrumb parts separator

//RSS SETTINGS
$description = "Galeria de fotos de avanildo.com.br";
...
$display_filename = true; // Show file names below the pictures
?>
