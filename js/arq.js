...
var acre=0.9580;
if (parcela==1){acre=0.9580} 
else if (parcela==2){acre=0.9332} 
else if (parcela==3){acre=0.9083} 
else if (parcela==4){acre=0.8834}
else if (parcela==5){acre=0.8585}
else if (parcela==6){acre=0.8336}
else if (parcela==7){acre=0.8087}
else if (parcela==8){acre=0.7898}
else if (parcela==9){acre=0.7589}
else if (parcela==10){acre=0.734}
else if (parcela==11){acre=0.7091}
else if (parcela==12){acre=0.6842}
else {alert("Digite o numero de parcela, minimo 2 e maximo de 12");
 
 return(0);
}

var po1=valor/acre;// aplica as taxas
var va=po1/parcela;// divide palcela
var fin= parseFloat(somar(valor,po1), 12).toFixed(2);// valor financiado
var res1=parseFloat(va, 12).toFixed(2);// valor das parcelas 
var t =res1*parcela; // valor financiado  
var tot=parseFloat(t, 12).toFixed(2); //formata total finaciado 
document.getElementById("resultado").innerHTML= "<hr>Financiando R$ "+valor+"<br /> Fica <strong> "+parcela+"X De R$ "+res1+" </strong><br />Total é de :R$ "+tot+"<br />";
}
